    ...
    return (
        <div className='space-y-10'>
            <header className='flex flex-col gap-4 md:flex-row md:items-end md:justify-between'>
                ...
                <button
                    className={
                        'inline-flex w-fit items-center gap-2 rounded-lg border ' +
                        'border-[var(--border)] bg-[var(--background)] px-4 py-2 ' +
                        'text-sm font-medium text-[var(--foreground)] shadow-sm ' +
                ...
                <div className='flex items-center justify-between border-b border-[var(--border)] px-6 py-4'>
                    ...
                    <Link
                        className={
                            ...
                            'text-[var(--primary)] transition hover:opacity-80'
                        }
                    ...
                    <table className='w-full border-collapse text-left'>
                        <thead>
                            <tr className={
                                ...
                                'text-xs uppercase tracking-[0.02em] text-[var(--muted-foreground)]'
                            }>
        ...
        <div className='admin-stitch-card flex min-h-[164px] flex-col justify-between p-6 transition-shadow duration-200 hover:shadow-md'>
            ...
            <div>
                ...
                <p className={
                    ...
                    `${trend === 'up' ? 'text-[var(--primary)]' : 'text-[var(--muted-foreground)]'}`
                }>
